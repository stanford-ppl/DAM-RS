...
mod tests {
    ...
    #[test]
    fn test_par4_multihead_attention() {
        ...
        // let mk_bounded = || {
        //    parent.bounded_with_flavor::<Token<u32, u32>>(
        //         chan_size,
        //         crate::channel::ChannelFlavor::Acyclic,
        //     )
        // };
        // let mk_boundedf = || {
        //    parent.bounded_with_flavor::<Token<f32, u32>>(
        //         chan_size,
        //         crate::channel::ChannelFlavor::Acyclic,
        //     )
        // };
        ...
        scat1.add_target(qk_out_ref_sender3);
        scat1.add_target(qk_out_ref_sender4);
        ...
        let (vk_out_ref_sender3, vk_out_ref_receiver3) = parent.bounded(chan_size);
        let (vk_out_ref_sender4, vk_out_ref_receiver4) = parent.bounded(chan_size);

        let mut scat2 = Scatter::new(out_repeat_vk_receiver);
        scat2.add_target(vk_out_ref_sender1);
        scat2.add_target(vk_out_ref_sender2);
        scat2.add_target(vk_out_ref_sender3);
        scat2.add_target(vk_out_ref_sender4);
        ...
        let (kk_out_ref_sender3, kk_out_ref_receiver3) = parent.bounded(chan_size);
        let (kk_out_ref_sender4, kk_out_ref_receiver4) = parent.bounded(chan_size);

        let mut scat3 = Scatter::new(out_repeat_kk_receiver);
        scat3.add_target(kk_out_ref_sender1);
        scat3.add_target(kk_out_ref_sender2);
        scat3.add_target(kk_out_ref_sender3);
        scat3.add_target(kk_out_ref_sender4);
        ...
        let (qk_out_crd_sender3, qk_out_crd_receiver3) = parent.bounded(chan_size);
        let (qk_out_crd_sender4, qk_out_crd_receiver4) = parent.bounded(chan_size);

        let mut scat4 = Scatter::new(bc2_qk_out_crd_receiver);
        scat4.add_target(qk_out_crd_sender1);
        scat4.add_target(qk_out_crd_sender2);
        scat4.add_target(qk_out_crd_sender3);
        scat4.add_target(qk_out_crd_sender4);
        ...
        let (kl_out_ref_sender3, kl_out_ref_receiver3) = parent.bounded(chan_size);
        let (kl_out_crd_sender3, kl_out_crd_receiver3) = parent.bounded(chan_size);
        let kl_data3 = RdScanData::<u32, u32> {
            in_ref: kk_out_ref_receiver3,
            out_ref: kl_out_ref_sender3,
            out_crd: kl_out_crd_sender3,
        };
        let kl_rdscanner3 = CompressedCrdRdScan::new(kl_data3, k1_seg.clone(), k1_crd.clone());

        let (kl_out_ref_sender4, kl_out_ref_receiver4) = parent.bounded(chan_size);
        let (kl_out_crd_sender4, kl_out_crd_receiver4) = parent.bounded(chan_size);
        let kl_data4 = RdScanData::<u32, u32> {
            in_ref: kk_out_ref_receiver4,
            out_ref: kl_out_ref_sender4,
            out_crd: kl_out_crd_sender4,
        };
        let kl_rdscanner4 = CompressedCrdRdScan::new(kl_data4, k1_seg.clone(), k1_crd.clone());
        ...
        let (vl_out_ref_sender3, vl_out_ref_receiver3) = parent.bounded(chan_size);
        let (vl_out_crd_sender3, vl_out_crd_receiver3) = parent.bounded(chan_size);
        let vl_data3 = RdScanData::<u32, u32> {
            in_ref: vk_out_ref_receiver3,
            out_ref: vl_out_ref_sender3,
            out_crd: vl_out_crd_sender3,
        };
        let vl_rdscanner3 = CompressedCrdRdScan::new(vl_data3, v1_seg.clone(), v1_crd.clone());

        let (vl_out_ref_sender4, vl_out_ref_receiver4) = parent.bounded(chan_size);
        let (vl_out_crd_sender4, vl_out_crd_receiver4) = parent.bounded(chan_size);
        let vl_data4 = RdScanData::<u32, u32> {
            in_ref: vk_out_ref_receiver4,
            out_ref: vl_out_ref_sender4,
            out_crd: vl_out_crd_sender4,
        };
        let vl_rdscanner4 = CompressedCrdRdScan::new(vl_data4, v1_seg.clone(), v1_crd.clone());
        ...
        let (intersectl_out_crd_sender3, intersectl_out_crd_receiver3) = parent.bounded(chan_size);
        let (intersectl_out_ref1_sender3, intersectl_out_ref1_receiver3) =
            parent.bounded(chan_size);
        let (intersectl_out_ref2_sender3, intersectl_out_ref2_receiver3) =
            parent.bounded(chan_size);
        let intersectl_data3 = CrdJoinerData::<u32, u32> {
            in_crd1: vl_out_crd_receiver3,
            in_ref1: vl_out_ref_receiver3,
            in_crd2: kl_out_crd_receiver3,
            in_ref2: kl_out_ref_receiver3,
            out_crd: intersectl_out_crd_sender3,
            out_ref1: intersectl_out_ref1_sender3,
            out_ref2: intersectl_out_ref2_sender3,
        };
        let intersect_l3 = Intersect::new(intersectl_data3);

        let (intersectl_out_crd_sender4, intersectl_out_crd_receiver4) = parent.bounded(chan_size);
        let (intersectl_out_ref1_sender4, intersectl_out_ref1_receiver4) =
            parent.bounded(chan_size);
        let (intersectl_out_ref2_sender4, intersectl_out_ref2_receiver4) =
            parent.bounded(chan_size);
        let intersectl_data4 = CrdJoinerData::<u32, u32> {
            in_crd1: vl_out_crd_receiver4,
            in_ref1: vl_out_ref_receiver4,
            in_crd2: kl_out_crd_receiver4,
            in_ref2: kl_out_ref_receiver4,
            out_crd: intersectl_out_crd_sender4,
            out_ref1: intersectl_out_ref1_sender4,
            out_ref2: intersectl_out_ref2_sender4,
        };
        let intersect_l4 = Intersect::new(intersectl_data4);
        ...
        let (bc1_intersectl_out_crd_sender1, bc1_intersectl_out_crd_receiver1) =
            parent.bounded(chan_size);
        // let (bc2_intersectl_out_crd_sender1, bc2_intersectl_out_crd_receiver1) = parent.bounded(chan_size);
        // let (bc3_intersectl_out_crd_sender1, bc3_intersectl_out_crd_receiver1) = parent.bounded(chan_size);
        // let (bc4_intersectl_out_crd_sender1, bc4_intersectl_out_crd_receiver1) = parent.bounded(chan_size);
        ...
        // broadcast17.add_target(bc3_intersectl_out_crd_sender1);
        // broadcast17.add_target(bc4_intersectl_out_crd_sender1);

        let (bc_intersectl_out_crd_sender2, bc_intersectl_out_crd_receiver2) =
            parent.bounded(chan_size);
        let (bc1_intersectl_out_crd_sender2, bc1_intersectl_out_crd_receiver2) =
            parent.bounded(chan_size);
        let mut broadcast37 = BroadcastContext::new(intersectl_out_crd_receiver2);
        broadcast37.add_target(bc_intersectl_out_crd_sender2);
        broadcast37.add_target(bc1_intersectl_out_crd_sender2);

        let (bc_intersectl_out_crd_sender3, bc_intersectl_out_crd_receiver3) =
            parent.bounded(chan_size);
        let (bc1_intersectl_out_crd_sender3, bc1_intersectl_out_crd_receiver3) =
            parent.bounded(chan_size);
        let mut broadcast38 = BroadcastContext::new(intersectl_out_crd_receiver3);
        broadcast38.add_target(bc_intersectl_out_crd_sender3);
        broadcast38.add_target(bc1_intersectl_out_crd_sender3);

        let (bc_intersectl_out_crd_sender4, bc_intersectl_out_crd_receiver4) =
            parent.bounded(chan_size);
        let (bc1_intersectl_out_crd_sender4, bc1_intersectl_out_crd_receiver4) =
            parent.bounded(chan_size);
        let mut broadcast29 = BroadcastContext::new(intersectl_out_crd_receiver4);
        broadcast29.add_target(bc_intersectl_out_crd_sender4);
        broadcast29.add_target(bc1_intersectl_out_crd_sender4);
        ...
        let (vm_out_ref_sender3, vm_out_ref_receiver3) = parent.bounded(chan_size);
        let (vm_out_crd_sender3, vm_out_crd_receiver3) = parent.bounded(chan_size);
        let vm_data3 = RdScanData::<u32, u32> {
            in_ref: intersectl_out_ref1_receiver3,
            out_ref: vm_out_ref_sender3,
            out_crd: vm_out_crd_sender3,
        };
        let vm_rdscanner3 = CompressedCrdRdScan::new(vm_data3, v3_seg.clone(), v3_crd.clone());

        let (vm_out_ref_sender4, vm_out_ref_receiver4) = parent.bounded(chan_size);
        let (vm_out_crd_sender4, vm_out_crd_receiver4) = parent.bounded(chan_size);
        let vm_data4 = RdScanData::<u32, u32> {
            in_ref: intersectl_out_ref1_receiver4,
            out_ref: vm_out_ref_sender4,
            out_crd: vm_out_crd_sender4,
        };
        let vm_rdscanner4 = CompressedCrdRdScan::new(vm_data4, v3_seg.clone(), v3_crd.clone());
        ...
        let (km_out_ref_sender3, km_out_ref_receiver3) = parent.bounded(chan_size);
        let (km_out_crd_sender3, km_out_crd_receiver3) = parent.bounded(chan_size);
        let km_data3 = RdScanData::<u32, u32> {
            in_ref: intersectl_out_ref2_receiver3,
            out_ref: km_out_ref_sender3,
            out_crd: km_out_crd_sender3,
        };
        let km_rdscanner3 = CompressedCrdRdScan::new(km_data3, k3_seg.clone(), k3_crd.clone());

        let (km_out_ref_sender4, km_out_ref_receiver4) = parent.bounded(chan_size);
        let (km_out_crd_sender4, km_out_crd_receiver4) = parent.bounded(chan_size);
        let km_data4 = RdScanData::<u32, u32> {
            in_ref: intersectl_out_ref2_receiver4,
            out_ref: km_out_ref_sender4,
            out_crd: km_out_crd_sender4,
        };
        let km_rdscanner4 = CompressedCrdRdScan::new(km_data4, k3_seg.clone(), k3_crd.clone());
        ...
        let (bc_km_out_ref_sender3, bc_km_out_ref_receiver3) = parent.bounded(chan_size);
        let (bc1_km_out_ref_sender3, bc1_km_out_ref_receiver3) = parent.bounded(chan_size);
        let mut broadcast30 = BroadcastContext::new(km_out_ref_receiver3);
        broadcast30.add_target(bc_km_out_ref_sender3);
        broadcast30.add_target(bc1_km_out_ref_sender3);
        ...
        let repsig_l_data2 = RepSigGenData::<u32, u32> {
            input: bc_intersectl_out_crd_receiver2,
            out_repsig: out_repsig_l_sender2,
        };
        let repsig_l2 = RepeatSigGen::new(repsig_l_data2);

        // repeatsiggen
        let (out_repsig_l_sender3, out_repsig_l_receiver3) = parent.bounded::<Repsiggen>(chan_size);
        let repsig_l_data3 = RepSigGenData::<u32, u32> {
            input: bc_intersectl_out_crd_receiver3,
            out_repsig: out_repsig_l_sender3,
        };
        let repsig_l3 = RepeatSigGen::new(repsig_l_data3);

        // repeatsiggen
        let (out_repsig_l_sender4, out_repsig_l_receiver4) = parent.bounded::<Repsiggen>(chan_size);
        let repsig_l_data4 = RepSigGenData::<u32, u32> {
            input: bc_intersectl_out_crd_receiver4,
            out_repsig: out_repsig_l_sender4,
        };
        let repsig_l4 = RepeatSigGen::new(repsig_l_data4);
        ...
        let (bc2_out_repsig_l_sender1, bc2_out_repsig_l_receiver1) =
            parent.bounded::<Repsiggen>(chan_size);
        // let (bc3_out_repsig_l_sender1, bc3_out_repsig_l_receiver1) =
        //    parent.bounded::<Repsiggen>(chan_size);
        // let (bc4_out_repsig_l_sender1, bc4_out_repsig_l_receiver1) =
        //    parent.bounded::<Repsiggen>(chan_size);
        ...
        // broadcast10.add_target(bc3_out_repsig_l_sender1);
        // broadcast10.add_target(bc4_out_repsig_l_sender1);
        ...
        let (bc2_out_repsig_l_sender2, bc2_out_repsig_l_receiver2) =
            parent.bounded::<Repsiggen>(chan_size);
        // let (bc3_out_repsig_l_sender2, bc3_out_repsig_l_receiver2) =
        //    parent.bounded::<Repsiggen>(chan_size);
        // let (bc4_out_repsig_l_sender2, bc4_out_repsig_l_receiver2) =
        //    parent.bounded::<Repsiggen>(chan_size);
        ...
        // broadcast4.add_target(bc3_out_repsig_l_sender2);
        // broadcast4.add_target(bc4_out_repsig_l_sender2);

        let (bc_out_repsig_l_sender3, bc_out_repsig_l_receiver3) =
            parent.bounded::<Repsiggen>(chan_size);
        let (bc1_out_repsig_l_sender3, bc1_out_repsig_l_receiver3) =
            parent.bounded::<Repsiggen>(chan_size);
        let (bc2_out_repsig_l_sender3, bc2_out_repsig_l_receiver3) =
            parent.bounded::<Repsiggen>(chan_size);
        let mut broadcast24 = BroadcastContext::new(out_repsig_l_receiver3);
        broadcast24.add_target(bc_out_repsig_l_sender3);
        broadcast24.add_target(bc1_out_repsig_l_sender3);
        broadcast24.add_target(bc2_out_repsig_l_sender3);

        let (bc_out_repsig_l_sender4, bc_out_repsig_l_receiver4) =
            parent.bounded::<Repsiggen>(chan_size);
        let (bc1_out_repsig_l_sender4, bc1_out_repsig_l_receiver4) =
            parent.bounded::<Repsiggen>(chan_size);
        let (bc2_out_repsig_l_sender4, bc2_out_repsig_l_receiver4) =
            parent.bounded::<Repsiggen>(chan_size);
        let mut broadcast25 = BroadcastContext::new(out_repsig_l_receiver4);
        broadcast25.add_target(bc_out_repsig_l_sender4);
        broadcast25.add_target(bc1_out_repsig_l_sender4);
        broadcast25.add_target(bc2_out_repsig_l_sender4);

        // repeat
        let (out_repeat_ql_sender1, out_repeat_ql_receiver1) = parent.bounded(chan_size);
        let ql_repeat_data1 = RepeatData::<u32, u32> {
            in_ref: qk_out_ref_receiver1,
            in_repsig: bc_out_repsig_l_receiver1,
            out_ref: out_repeat_ql_sender1,
        };
        let ql_repeat1 = Repeat::new(ql_repeat_data1);
        ...
        // repeat
        let (out_repeat_ql_sender3, out_repeat_ql_receiver3) = parent.bounded(chan_size);
        let ql_repeat_data3 = RepeatData::<u32, u32> {
            in_ref: qk_out_ref_receiver3,
            in_repsig: bc_out_repsig_l_receiver3,
            out_ref: out_repeat_ql_sender3,
        };
        let ql_repeat3 = Repeat::new(ql_repeat_data3);

        // repeat
        let (out_repeat_ql_sender4, out_repeat_ql_receiver4) = parent.bounded(chan_size);
        let ql_repeat_data4 = RepeatData::<u32, u32> {
            in_ref: qk_out_ref_receiver4,
            in_repsig: bc_out_repsig_l_receiver4,
            out_ref: out_repeat_ql_sender4,
        };
        let ql_repeat4 = Repeat::new(ql_repeat_data4);
        ...
        let (qm_out_ref_sender3, qm_out_ref_receiver3) = parent.bounded(chan_size);
        let (qm_out_crd_sender3, qm_out_crd_receiver3) = parent.bounded(chan_size);
        let qm_data3 = RdScanData::<u32, u32> {
            in_ref: out_repeat_ql_receiver3,
            out_ref: qm_out_ref_sender3,
            out_crd: qm_out_crd_sender3,
        };
        let qm_rdscanner3 = CompressedCrdRdScan::new(qm_data3, q3_seg.clone(), q3_crd.clone());

        let (qm_out_ref_sender4, qm_out_ref_receiver4) = parent.bounded(chan_size);
        let (qm_out_crd_sender4, qm_out_crd_receiver4) = parent.bounded(chan_size);
        let qm_data4 = RdScanData::<u32, u32> {
            in_ref: out_repeat_ql_receiver4,
            out_ref: qm_out_ref_sender4,
            out_crd: qm_out_crd_sender4,
        };
        let qm_rdscanner4 = CompressedCrdRdScan::new(qm_data4, q3_seg.clone(), q3_crd.clone());
        ...
        let (intersectm_out_crd_sender3, intersectm_out_crd_receiver3) = parent.bounded(chan_size);
        let (intersectm_out_ref1_sender3, intersectm_out_ref1_receiver3) =
            parent.bounded(chan_size);
        let (intersectm_out_ref2_sender3, intersectm_out_ref2_receiver3) =
            parent.bounded(chan_size);
        let intersectm_data3 = CrdJoinerData::<u32, u32> {
            in_crd1: vm_out_crd_receiver3,
            in_ref1: vm_out_ref_receiver3,
            in_crd2: qm_out_crd_receiver3,
            in_ref2: qm_out_ref_receiver3,
            out_crd: intersectm_out_crd_sender3,
            out_ref1: intersectm_out_ref1_sender3,
            out_ref2: intersectm_out_ref2_sender3,
        };
        let intersect_m_3 = Intersect::new(intersectm_data3);
        // dbg!(intersect_m.id());

        let (intersectm_out_crd_sender4, intersectm_out_crd_receiver4) = parent.bounded(chan_size);
        let (intersectm_out_ref1_sender4, intersectm_out_ref1_receiver4) =
            parent.bounded(chan_size);
        let (intersectm_out_ref2_sender4, intersectm_out_ref2_receiver4) =
            parent.bounded(chan_size);
        let intersectm_data4 = CrdJoinerData::<u32, u32> {
            in_crd1: vm_out_crd_receiver4,
            in_ref1: vm_out_ref_receiver4,
            in_crd2: qm_out_crd_receiver4,
            in_ref2: qm_out_ref_receiver4,
            out_crd: intersectm_out_crd_sender4,
            out_ref1: intersectm_out_ref1_sender4,
            out_ref2: intersectm_out_ref2_sender4,
        };
        let intersect_m_4 = Intersect::new(intersectm_data4);
        // dbg!(intersect_m.id());
        ...
        // let (bc2_km_out_crd_sender1, bc2_km_out_crd_receiver1) = parent.bounded(chan_size);
        // let (bc3_km_out_crd_sender1, bc3_km_out_crd_receiver1) = parent.bounded(chan_size);
        ...
        // broadcast13.add_target(bc2_km_out_crd_sender1);
        // broadcast13.add_target(bc3_km_out_crd_sender1);
        ...
        let (bc_intersectm_out_crd_sender3, bc_intersectm_out_crd_receiver3) =
            parent.bounded(chan_size);
        let (bc1_intersectm_out_crd_sender3, bc1_intersectm_out_crd_receiver3) =
            parent.bounded(chan_size);
        let mut broadcast26 = BroadcastContext::new(intersectm_out_crd_receiver3);
        broadcast26.add_target(bc_intersectm_out_crd_sender3);
        broadcast26.add_target(bc1_intersectm_out_crd_sender3);

        let (bc_intersectm_out_crd_sender4, bc_intersectm_out_crd_receiver4) =
            parent.bounded(chan_size);
        let (bc1_intersectm_out_crd_sender4, bc1_intersectm_out_crd_receiver4) =
            parent.bounded(chan_size);
        let mut broadcast27 = BroadcastContext::new(intersectm_out_crd_receiver4);
        broadcast27.add_target(bc_intersectm_out_crd_sender4);
        broadcast27.add_target(bc1_intersectm_out_crd_sender4);
        ...
        let (bc_km_out_crd_sender3, bc_km_out_crd_receiver3) = parent.bounded(chan_size);
        let (bc1_km_out_crd_sender3, bc1_km_out_crd_receiver3) = parent.bounded(chan_size);
        let mut broadcast28 = BroadcastContext::new(km_out_crd_receiver3);
        broadcast28.add_target(bc_km_out_crd_sender3);
        broadcast28.add_target(bc1_km_out_crd_sender3);

        let (bc_km_out_crd_sender4, bc_km_out_crd_receiver4) = parent.bounded(chan_size);
        let (bc1_km_out_crd_sender4, bc1_km_out_crd_receiver4) = parent.bounded(chan_size);
        let mut broadcast39 = BroadcastContext::new(km_out_crd_receiver4);
        broadcast39.add_target(bc_km_out_crd_sender4);
        broadcast39.add_target(bc1_km_out_crd_sender4);
        ...
        let (intersectm2_out_ref2_sender3, intersectm2_out_ref2_receiver3) =
            parent.bounded(chan_size);
        let intersectm2_data3 = CrdJoinerData::<u32, u32> {
            in_crd1: bc_km_out_crd_receiver3,
            in_ref1: bc_km_out_ref_receiver3,
            in_crd2: bc_intersectm_out_crd_receiver3,
            in_ref2: intersectm_out_ref1_receiver3,
            out_crd: parent.void(),
            out_ref1: parent.void(),
            out_ref2: intersectm2_out_ref2_sender3,
        };
        let intersect_m2_3 = Intersect::new(intersectm2_data3);

        let (intersectm2_out_ref2_sender4, intersectm2_out_ref2_receiver4) =
            parent.bounded(chan_size);
        let intersectm2_data4 = CrdJoinerData::<u32, u32> {
            in_crd1: bc_km_out_crd_receiver4,
            in_ref1: bc_km_out_ref_receiver4,
            in_crd2: bc_intersectm_out_crd_receiver4,
            in_ref2: intersectm_out_ref1_receiver4,
            out_crd: parent.void(),
            out_ref1: parent.void(),
            out_ref2: intersectm2_out_ref2_sender4,
        };
        let intersect_m2_4 = Intersect::new(intersectm2_data4);
        ...
        let (intersectm3_out_crd_sender3, intersectm3_out_crd_receiver3) =
            parent.bounded(chan_size);
        // let (intersectm3_out_ref1_sender, intersectm3_out_ref1_receiver) =
        let (intersectm3_out_ref1_sender3, intersectm3_out_ref1_receiver3) =
            parent.bounded(chan_size);
        let (intersectm3_out_ref2_sender3, intersectm3_out_ref2_receiver3) =
            parent.bounded(chan_size);

        let intersectm3_data3 = CrdJoinerData::<u32, u32> {
            in_crd1: bc1_km_out_crd_receiver3,
            in_ref1: bc1_km_out_ref_receiver3,
            in_crd2: bc1_intersectm_out_crd_receiver3,
            in_ref2: intersectm_out_ref2_receiver3,
            out_crd: intersectm3_out_crd_sender3,
            out_ref1: intersectm3_out_ref1_sender3,
            out_ref2: intersectm3_out_ref2_sender3,
        };
        let intersect_m3_3 = Intersect::new(intersectm3_data3);

        let (intersectm3_out_crd_sender4, intersectm3_out_crd_receiver4) =
            parent.bounded(chan_size);
        let (intersectm3_out_ref1_sender4, intersectm3_out_ref1_receiver4) =
            parent.bounded(chan_size);
        let (intersectm3_out_ref2_sender4, intersectm3_out_ref2_receiver4) =
            parent.bounded(chan_size);
        let intersectm3_data4 = CrdJoinerData::<u32, u32> {
            in_crd1: bc1_km_out_crd_receiver4,
            in_ref1: bc1_km_out_ref_receiver4,
            in_crd2: bc1_intersectm_out_crd_receiver4,
            in_ref2: intersectm_out_ref2_receiver4,
            out_crd: intersectm3_out_crd_sender4,
            out_ref1: intersectm3_out_ref1_sender4,
            out_ref2: intersectm3_out_ref2_sender4,
        };
        let intersect_m3_4 = Intersect::new(intersectm3_data4);
        ...
        let (bc_intersectm3_out_crd_sender3, bc_intersectm3_out_crd_receiver3) =
            parent.bounded(chan_size);
        let (bc1_intersectm3_out_crd_sender3, bc1_intersectm3_out_crd_receiver3) =
            parent.bounded(chan_size);
        let mut broadcast31 = BroadcastContext::new(intersectm3_out_crd_receiver3);
        broadcast31.add_target(bc_intersectm3_out_crd_sender3);
        broadcast31.add_target(bc1_intersectm3_out_crd_sender3);

        let (bc_intersectm3_out_crd_sender4, bc_intersectm3_out_crd_receiver4) =
            parent.bounded(chan_size);
        let (bc1_intersectm3_out_crd_sender4, bc1_intersectm3_out_crd_receiver4) =
            parent.bounded(chan_size);
        let mut broadcast32 = BroadcastContext::new(intersectm3_out_crd_receiver4);
        broadcast32.add_target(bc_intersectm3_out_crd_sender4);
        broadcast32.add_target(bc1_intersectm3_out_crd_sender4);
        ...
        // arrayvals_q
        let (q_out_val_sender3, q_out_val_receiver3) = parent.bounded(chan_size);
        let arrayvals_q_data3 = ArrayData::<u32, f32, u32> {
            in_ref: intersectm3_out_ref2_receiver3,
            out_val: q_out_val_sender3,
        };
        let arrayvals_q3 = Array::<u32, f32, u32>::new(arrayvals_q_data3, q_vals.clone());

        // arrayvals_q
        let (q_out_val_sender4, q_out_val_receiver4) = parent.bounded(chan_size);
        let arrayvals_q_data4 = ArrayData::<u32, f32, u32> {
            in_ref: intersectm3_out_ref2_receiver4,
            out_val: q_out_val_sender4,
        };
        let arrayvals_q4 = Array::<u32, f32, u32>::new(arrayvals_q_data4, q_vals.clone());
        ...
        // arrayvals_k
        let (k_out_val_sender3, k_out_val_receiver3) = parent.bounded(chan_size);
        let arrayvals_k_data3 = ArrayData::<u32, f32, u32> {
            in_ref: intersectm3_out_ref1_receiver3,
            out_val: k_out_val_sender3,
        };
        let arrayvals_k3 = Array::<u32, f32, u32>::new(arrayvals_k_data3, k_vals.clone());

        // arrayvals_k
        let (k_out_val_sender4, k_out_val_receiver4) = parent.bounded(chan_size);
        let arrayvals_k_data4 = ArrayData::<u32, f32, u32> {
            in_ref: intersectm3_out_ref1_receiver4,
            out_val: k_out_val_sender4,
        };
        let arrayvals_k4 = Array::<u32, f32, u32>::new(arrayvals_k_data4, k_vals.clone());
        ...
        // arrayvals_v
        let (v_out_val_sender3, v_out_val_receiver3) = parent.bounded(chan_size);
        let arrayvals_v_data3 = ArrayData::<u32, f32, u32> {
            in_ref: intersectm2_out_ref2_receiver3,
            out_val: v_out_val_sender3,
        };
        let arrayvals_v3 = Array::<u32, f32, u32>::new(arrayvals_v_data3, v_vals.clone());

        // arrayvals_v
        let (v_out_val_sender4, v_out_val_receiver4) = parent.bounded(chan_size);
        let arrayvals_v_data4 = ArrayData::<u32, f32, u32> {
            in_ref: intersectm2_out_ref2_receiver4,
            out_val: v_out_val_sender4,
        };
        let arrayvals_v4 = Array::<u32, f32, u32>::new(arrayvals_v_data4, v_vals.clone());
        ...
        // mul ALU
        let (mul_out_sender4, mul_out_receiver4) = parent.bounded(chan_size);
        let mul4 = make_alu(
            q_out_val_receiver4,
            k_out_val_receiver4,
            mul_out_sender4,
        ...
        // Reduce
        let (red_out_sender3, red_out_receiver3) = parent.bounded(chan_size);
        let red_data3 = ReduceData::<f32, u32> {
            in_val: mul_out_receiver3,
            out_val: red_out_sender3,
        };
        let red3 = Reduce::new(red_data3);

        // Reduce
        let (red_out_sender4, red_out_receiver4) = parent.bounded(chan_size);
        let red_data4 = ReduceData::<f32, u32> {
            in_val: mul_out_receiver4,
            out_val: red_out_sender4,
        };
        let red4 = Reduce::new(red_data4);
        ...
        let (bc_out_red_sender3, bc_out_red_receiver3) = parent.bounded(chan_size);
        let (bc1_out_red_sender3, bc1_out_red_receiver3) = parent.bounded(chan_size);
        let mut broadcast33 = BroadcastContext::new(red_out_receiver3);
        broadcast33.add_target(bc_out_red_sender3);
        broadcast33.add_target(bc1_out_red_sender3);

        let (bc_out_red_sender4, bc_out_red_receiver4) = parent.bounded(chan_size);
        let (bc1_out_red_sender4, bc1_out_red_receiver4) = parent.bounded(chan_size);
        let mut broadcast34 = BroadcastContext::new(red_out_receiver4);
        broadcast34.add_target(bc_out_red_sender4);
        broadcast34.add_target(bc1_out_red_sender4);
        ...
        // Max Reduce
        let (max_out_val_sender3, max_out_val_receiver3) = parent.bounded(chan_size);
        let max_data3 = ReduceData::<f32, u32> {
            in_val: bc_out_red_receiver3,
            out_val: max_out_val_sender3,
        };
        let max_red3 = MaxReduce::new(max_data3, f32::MIN);

        // Max Reduce
        let (max_out_val_sender4, max_out_val_receiver4) = parent.bounded(chan_size);
        let max_data4 = ReduceData::<f32, u32> {
            in_val: bc_out_red_receiver4,
            out_val: max_out_val_sender4,
        };
        let max_red4 = MaxReduce::new(max_data4, f32::MIN);
        ...
        let (rep_out_val_sender3, rep_out_val_receiver3) = parent.bounded(chan_size);
        let rep_data3 = RepeatData::<f32, u32> {
            in_ref: max_out_val_receiver3,
            in_repsig: bc1_out_repsig_l_receiver3,
            out_ref: rep_out_val_sender3,
        };
        let rep3 = Repeat::new(rep_data3);

        let (rep_out_val_sender4, rep_out_val_receiver4) = parent.bounded(chan_size);
        let rep_data4 = RepeatData::<f32, u32> {
            in_ref: max_out_val_receiver4,
            in_repsig: bc1_out_repsig_l_receiver4,
            out_ref: rep_out_val_sender4,
        };
        let rep4 = Repeat::new(rep_data4);
        ...
        // Sub ALU, using Add name to correspond to SAM implementation
        let (add_out_sender3, add_out_receiver3) = parent.bounded(chan_size);
        let add3 = make_alu(
            bc1_out_red_receiver3,
            rep_out_val_receiver3,
            add_out_sender3,
            ALUSubOp(),
        );

        // Sub ALU, using Add name to correspond to SAM implementation
        let (add_out_sender4, add_out_receiver4) = parent.bounded(chan_size);
        let add4 = make_alu(
            bc1_out_red_receiver4,
            rep_out_val_receiver4,
            add_out_sender4,
            ALUSubOp(),
        );
        ...
        // Exp
        let (exp_out_sender3, exp_out_receiver3) = parent.bounded(chan_size);
        let exp3 = make_unary_alu(add_out_receiver3, exp_out_sender3, ALUExpOp());
        // Exp
        let (exp_out_sender4, exp_out_receiver4) = parent.bounded(chan_size);
        let exp4 = make_unary_alu(add_out_receiver4, exp_out_sender4, ALUExpOp());
        ...
        let (bc_exp_out_sender3, bc_exp_out_receiver3) = parent.bounded(chan_size);
        let (bc1_exp_out_sender3, bc1_exp_out_receiver3) = parent.bounded(chan_size);
        let mut broadcast35 = BroadcastContext::new(exp_out_receiver3);
        broadcast35.add_target(bc_exp_out_sender3);
        broadcast35.add_target(bc1_exp_out_sender3);

        let (bc_exp_out_sender4, bc_exp_out_receiver4) = parent.bounded(chan_size);
        let (bc1_exp_out_sender4, bc1_exp_out_receiver4) = parent.bounded(chan_size);
        let mut broadcast36 = BroadcastContext::new(exp_out_receiver4);
        broadcast36.add_target(bc_exp_out_sender4);
        broadcast36.add_target(bc1_exp_out_sender4);
        ...
        // Reduce
        let (red1_out_sender3, red1_out_receiver3) = parent.bounded(chan_size);
        let red1_data3 = ReduceData::<f32, u32> {
            in_val: bc_exp_out_receiver3,
            out_val: red1_out_sender3,
        };
        let red1_3 = Reduce::new(red1_data3);

        // Reduce
        let (red1_out_sender4, red1_out_receiver4) = parent.bounded(chan_size);
        let red1_data4 = ReduceData::<f32, u32> {
            in_val: bc_exp_out_receiver4,
            out_val: red1_out_sender4,
        };
        let red1_4 = Reduce::new(red1_data4);
        ...
        let (rep1_out_val_sender3, rep1_out_val_receiver3) = parent.bounded(chan_size);
        let rep1_data3 = RepeatData::<f32, u32> {
            in_ref: red1_out_receiver3,
            in_repsig: bc2_out_repsig_l_receiver3,
            out_ref: rep1_out_val_sender3,
        };
        let rep1_3 = Repeat::new(rep1_data3);

        let (rep1_out_val_sender4, rep1_out_val_receiver4) = parent.bounded(chan_size);
        let rep1_data4 = RepeatData::<f32, u32> {
            in_ref: red1_out_receiver4,
            in_repsig: bc2_out_repsig_l_receiver4,
            out_ref: rep1_out_val_sender4,
        };
        let rep1_4 = Repeat::new(rep1_data4);
        ...
        // Div ALU
        let (div_out_sender3, div_out_receiver3) = parent.bounded(chan_size);
        let div3 = make_alu(
            bc1_exp_out_receiver3,
            rep1_out_val_receiver3,
            div_out_sender3,
            ALUDivOp(),
        );

        // Div ALU
        let (div_out_sender4, div_out_receiver4) = parent.bounded(chan_size);
        let div4 = make_alu(
            bc1_exp_out_receiver4,
            rep1_out_val_receiver4,
            div_out_sender4,
            ALUDivOp(),
        );
        ...
        let (out_repsig_m_sender3, out_repsig_m_receiver3) = parent.bounded::<Repsiggen>(chan_size);
        let repsig_m_data3 = RepSigGenData::<u32, u32> {
            input: bc_intersectm3_out_crd_receiver3,
            out_repsig: out_repsig_m_sender3,
        };
        let repsigm3 = RepeatSigGen::new(repsig_m_data3);

        let (out_repsig_m_sender4, out_repsig_m_receiver4) = parent.bounded::<Repsiggen>(chan_size);
        let repsig_m_data4 = RepSigGenData::<u32, u32> {
            input: bc_intersectm3_out_crd_receiver4,
            out_repsig: out_repsig_m_sender4,
        };
        let repsigm4 = RepeatSigGen::new(repsig_m_data4);
        ...
        let (rep_m_out_val_sender3, rep_m_out_val_receiver3) = parent.bounded(chan_size);
        let rep2_data3 = RepeatData::<f32, u32> {
            // in_ref: out_drop_val_receiver,
            in_ref: div_out_receiver3,
            in_repsig: out_repsig_m_receiver3,
            out_ref: rep_m_out_val_sender3,
        };
        let rep_m3 = Repeat::new(rep2_data3);

        let (rep_m_out_val_sender4, rep_m_out_val_receiver4) = parent.bounded(chan_size);
        let rep2_data4 = RepeatData::<f32, u32> {
            // in_ref: out_drop_val_receiver,
            in_ref: div_out_receiver4,
            in_repsig: out_repsig_m_receiver4,
            out_ref: rep_m_out_val_sender4,
        };
        let rep_m4 = Repeat::new(rep2_data4);
        ...
        // mul ALU
        let (mul2_out_sender3, mul2_out_receiver3) = parent.bounded(chan_size);
        let mul2_3 = make_alu(
            rep_m_out_val_receiver3,
            v_out_val_receiver3,
            mul2_out_sender3,
            ALUMulOp(),
        );
        ...
        // mul ALU
        let (mul2_out_sender4, mul2_out_receiver4) = parent.bounded(chan_size);
        let mul2_4 = make_alu(
            rep_m_out_val_receiver4,
            v_out_val_receiver4,
            mul2_out_sender4,
            ALUMulOp(),
        );
        ...
        let crd_drop_data2 = CrdManagerData::<u32, u32> {
            ...
            in_crd_inner: bc1_intersectl_out_crd_receiver2,
            out_crd_outer: parent.void(),
            out_crd_inner: drop_out_icrd_sender2,
        };
        let drop2 = CrdDrop::new(crd_drop_data2);

        let (drop_out_icrd_sender3, drop_out_icrd_receiver3) = parent.bounded(chan_size);
        let crd_drop_data3 = CrdManagerData::<u32, u32> {
            in_crd_outer: qk_out_crd_receiver3,
            in_crd_inner: bc1_intersectl_out_crd_receiver3,
            out_crd_outer: parent.void(),
            out_crd_inner: drop_out_icrd_sender3,
        };
        let drop3 = CrdDrop::new(crd_drop_data3);

        let (drop_out_icrd_sender4, drop_out_icrd_receiver4) = parent.bounded(chan_size);
        let crd_drop_data4 = CrdManagerData::<u32, u32> {
            in_crd_outer: qk_out_crd_receiver4,
            in_crd_inner: bc1_intersectl_out_crd_receiver4,
            out_crd_outer: parent.void(),
            out_crd_inner: drop_out_icrd_sender4,
        };
        let drop4 = CrdDrop::new(crd_drop_data4);
        ...
        let (out_spacc_val_sender3, out_spacc_val_receiver3) = parent.bounded(chan_size);
        let (out_spacc_icrd_sender3, out_spacc_icrd_receiver3) = parent.bounded(chan_size);
        let spacc_data3 = Spacc1Data::<u32, f32, u32> {
            in_crd_outer: drop_out_icrd_receiver3,
            in_crd_inner: bc1_intersectm3_out_crd_receiver3,
            in_val: mul2_out_receiver3,
            out_val: out_spacc_val_sender3,
            out_crd_inner: out_spacc_icrd_sender3,
        };
        let spacc3 = Spacc1::new(spacc_data3);

        let (out_spacc_val_sender4, out_spacc_val_receiver4) = parent.bounded(chan_size);
        let (out_spacc_icrd_sender4, out_spacc_icrd_receiver4) = parent.bounded(chan_size);
        let spacc_data4 = Spacc1Data::<u32, f32, u32> {
            in_crd_outer: drop_out_icrd_receiver4,
            in_crd_inner: bc1_intersectm3_out_crd_receiver4,
            in_val: mul2_out_receiver4,
            out_val: out_spacc_val_sender4,
            out_crd_inner: out_spacc_icrd_sender4,
        };
        let spacc4 = Spacc1::new(spacc_data4);
        ...
        gat.add_target(out_spacc_val_receiver3);
        gat.add_target(out_spacc_val_receiver4);
        ...
        gat1.add_target(out_spacc_icrd_receiver3);
        ...
        parent.add_child(broadcast24);
        parent.add_child(broadcast25);
        parent.add_child(broadcast26);
        parent.add_child(broadcast27);
        parent.add_child(broadcast28);
        parent.add_child(broadcast29);
        parent.add_child(broadcast30);
        parent.add_child(broadcast31);
        parent.add_child(broadcast32);
        parent.add_child(broadcast33);
        parent.add_child(broadcast34);
        parent.add_child(broadcast35);
        ...
        parent.add_child(kl_rdscanner3);
        parent.add_child(kl_rdscanner4);
        parent.add_child(vl_rdscanner1);
        parent.add_child(vl_rdscanner2);
        parent.add_child(vl_rdscanner3);
        parent.add_child(vl_rdscanner4);
        parent.add_child(intersect_l1);
        parent.add_child(intersect_l2);
        parent.add_child(intersect_l3);
        parent.add_child(intersect_l4);
        parent.add_child(km_rdscanner1);
        parent.add_child(km_rdscanner2);
        parent.add_child(km_rdscanner3);
        parent.add_child(km_rdscanner4);
        parent.add_child(vm_rdscanner1);
        parent.add_child(vm_rdscanner2);
        parent.add_child(vm_rdscanner3);
        parent.add_child(vm_rdscanner4);
        parent.add_child(repsig_l1);
        parent.add_child(repsig_l2);
        parent.add_child(repsig_l3);
        parent.add_child(repsig_l4);
        parent.add_child(ql_repeat1);
        parent.add_child(ql_repeat3);
        parent.add_child(ql_repeat4);
        parent.add_child(qm_rdscanner1);
        parent.add_child(qm_rdscanner2);
        parent.add_child(qm_rdscanner3);
        parent.add_child(qm_rdscanner4);
        parent.add_child(intersect_m_1);
        parent.add_child(intersect_m_2);
        parent.add_child(intersect_m_3);
        parent.add_child(intersect_m_4);
        parent.add_child(intersect_m2_1);
        parent.add_child(intersect_m2_2);
        parent.add_child(intersect_m2_3);
        parent.add_child(intersect_m2_4);
        parent.add_child(intersect_m3_1);
        parent.add_child(intersect_m3_2);
        parent.add_child(intersect_m3_3);
        parent.add_child(intersect_m3_4);
        parent.add_child(arrayvals_q1);
        parent.add_child(arrayvals_q2);
        parent.add_child(arrayvals_q3);
        parent.add_child(arrayvals_q4);
        parent.add_child(arrayvals_k1);
        parent.add_child(arrayvals_k2);
        parent.add_child(arrayvals_k3);
        parent.add_child(arrayvals_k4);
        parent.add_child(arrayvals_v1);
        parent.add_child(arrayvals_v2);
        parent.add_child(arrayvals_v3);
        parent.add_child(arrayvals_v4);
        parent.add_child(mul1);
        parent.add_child(mul2);
        parent.add_child(mul3);
        parent.add_child(mul4);
        parent.add_child(mul2_1);
        parent.add_child(mul2_2);
        parent.add_child(mul2_3);
        parent.add_child(mul2_4);
        parent.add_child(xvals);
        parent.add_child(red1);
        parent.add_child(red2);
        parent.add_child(red3);
        parent.add_child(red4);
        parent.add_child(red1_1);
        parent.add_child(red1_2);
        parent.add_child(red1_3);
        parent.add_child(red1_4);
        parent.add_child(max_red1);
        parent.add_child(max_red2);
        parent.add_child(max_red3);
        parent.add_child(max_red4);
        parent.add_child(rep1);
        parent.add_child(rep2);
        parent.add_child(rep3);
        parent.add_child(rep4);
        parent.add_child(rep1_1);
        parent.add_child(rep1_2);
        parent.add_child(rep1_3);
        parent.add_child(rep1_4);
        parent.add_child(add1);
        parent.add_child(add2);
        parent.add_child(add3);
        parent.add_child(add4);
        parent.add_child(exp1);
        parent.add_child(exp2);
        parent.add_child(exp3);
        parent.add_child(exp4);
        // parent.add_child(rep1);
        parent.add_child(div1);
        parent.add_child(div2);
        parent.add_child(div3);
        parent.add_child(div4);
        parent.add_child(drop1);
        parent.add_child(spacc2);
        parent.add_child(spacc3);
        parent.add_child(spacc4);
        // parent.add_child(val_drop);
        parent.add_child(repsigm1);
        parent.add_child(repsigm2);
        parent.add_child(repsigm3);
        parent.add_child(repsigm4);
        parent.add_child(rep_m1);
        parent.add_child(rep_m2);
        parent.add_child(rep_m3);
        parent.add_child(rep_m4);
