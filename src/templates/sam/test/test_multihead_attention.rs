...
mod tests {
    ...
    fn test_multihead_attention() {
        ...
        // fiberwrite_X0
        let mut x0_wrscanner = CompressedWrScan::new(intersecti2_out_crd_receiver);

        // fiberwrite_X1
        let mut x1_wrscanner = CompressedWrScan::new(bc1_qk_out_crd_receiver);

        // fiberwrite_X2
        let mut x2_wrscanner = CompressedWrScan::new(intersectj3_out_crd_receiver);

        // fiberwrite_X3
        let mut x3_wrscanner = CompressedWrScan::new(out_spacc_icrd_receiver);

        // fiberwrite_Xvals
        let mut xvals = ValsWrScan::<f32, u32>::new(out_spacc_val_receiver);
